...
namespace factory
{
  std::shared_ptr<button> button_factory::build_imagebutton(std::string name, std::string file, std::function<void()> f, std::shared_ptr<waifuengine::object_management::space> sp)
  {
  ...
  std::shared_ptr<button> button_factory::build_textbutton(std::string name, std::string file, std::string text, std::function<void()> f, std::shared_ptr<waifuengine::object_management::space> sp)
  {
    auto obj = build_imagebutton(name, file, f, sp);
