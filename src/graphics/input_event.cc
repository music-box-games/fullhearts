  ...
  namespace graphics
  {
    namespace input
    {
      ...
      std::unordered_map<sfks, keys> keymap =
      {
        ...
        {sfks::Dash, keys::minus}, {sfks::Equal, keys::equals}, {sfks::BackSpace, keys::backspace},
        ...
        {sfks::LAlt, keys::lalt}, {sfks::Space, keys::space}, {sfks::RAlt, keys::ralt}, {sfks::RControl, keys::rctrl},
      ...
      input_event::input_event(keys k, actions a) : event(std::string(NAME)), key(k), action(a) {}
